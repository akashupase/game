...
local answer4 = display.newImage("images/answer4.png", display.contentCenterX, display.contentCenterY - 80)
local option1 = display.newImage("images/option4_3.png",90,200)
local option2 = display.newImage("images/option4_2.png", 400, 200)
local option3 = display.newImage("images/option4_1.png", 90, 280)
local option4 = display.newImage("images/option4_4.png", 400, 280)


option1:addEventListener("touch", onOption1Touch)
option2:addEventListener("touch", onOption2Touch)
option3:addEventListener("touch", onOption4Touch)
option4:addEventListener("touch", onOption3Touch)

sceneGroup:insert(option1)
sceneGroup:insert(option2)
sceneGroup:insert(option3)
sceneGroup:insert(option4)
sceneGroup:insert(answer4)
...
function onOption4Touch( event )
  ...
  composer.removeScene("scenes.win4", false)

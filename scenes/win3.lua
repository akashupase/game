...
local answer3 = display.newImage("images/answer3.png", display.contentCenterX, display.contentCenterY - 80)
local option1 = display.newImage("images/option3_1.png",90,200)
local option2 = display.newImage("images/option3_3.png", 400, 200)
local option3 = display.newImage("images/option3_2.png", 90, 280)
local option4 = display.newImage("images/option3_4.png", 400, 280)
...
function onOption3Touch( event )
  print("Right")
  composer.removeScene("scenes.win3", false)

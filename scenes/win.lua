...
local answer1 = display.newImage("images/answer1.png", display.contentCenterX, display.contentCenterY - 80)
local option1 = display.newImage("images/option1.png",90,200)
local option2 = display.newImage("images/option2.png", 400, 200)
local option3 = display.newImage("images/option3.png", 90, 280)
local option4 = display.newImage("images/option4.png", 400, 280)
...
function onOption1Touch( event )
  print("Right")
  composer.removeScene("scenes.win", false)
